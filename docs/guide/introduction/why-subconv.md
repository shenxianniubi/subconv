...
The subscription and node parsing are aligned with [mihomo](https://github.com/MetaCubeX/mihomo/tree/Meta/common/convert), so it follows mihomo's share-link conversion behavior as closely as possible.
